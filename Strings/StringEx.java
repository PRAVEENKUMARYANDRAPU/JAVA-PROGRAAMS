...
class Operations
  {
    ...
    String s2=String.format("%.3f",45.672323);
     System.out.println(s2); //45.672
...
class Operations
  {
    public static void main(String args[])
    {
     String s="welcome to bilabs to house";
     int index=s.lastIndexOf("to");
...
class Operations
  {
    ...
    {
     String s="welcome to bilabs to house";
     int index=s.indexOf("to");
      System.out.println("index value of first occurance of the character:"+index); //8
